...
exports.sendResetPasswordEmail = (email, link) => {
    ...
    <h5>Stock protfolio</h5>
    <h1>Återställ lösenord</h1>
    <h3>Oroar dig inte. Klicka bara på knappen under för att återställa ditt lösenord.</h3>
    <h5>Ignorera detta mejl ifall du inte onskade att återställa ditt lösenord.</h5>
    <a href='${link}' style='
    display: block;
    background: #ffd98d;
